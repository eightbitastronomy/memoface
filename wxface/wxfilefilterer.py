...
class wxFileFilterer(wx.Panel):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.__file_cb = wx.CheckBox(self, wx.ID_ANY)
        self.__file_cb.SetValue(False)
        ...
        self.__file_b = wx.Button(self,
                                  file_chooser_id,
                                  "Select")
        self.main_sizer.Add(self.__file_cb, 0, wx.EXPAND, 0)
        #self.main_sizer.AddSpacer(5)
        self.main_sizer.Add(self.__file_l, 0, wx.CENTRE, 0)
    ...
    def is_checked(self):
        return self.__file_cb.GetValue()